...
export default function AnalyticsPage() {
  ...
  // 📝 Fetch Analytics Metrics with Security Token Applied
  useEffect(() => {
    const fetchAnalyticsData = async () => {
      try {
        ...
        console.error("Error fetching analytics metrics pipeline:", err);
      } finally {
        setLoading(false);
      }
    };
