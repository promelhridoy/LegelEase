...
export default function TransactionsPage() {
  ...
  return (
    ...
    >
      ...
      {/* LOADING STATE */}
      {loading && (
        <div className="text-center text-white/50 text-xs font-mono py-10">
          Loading synchronized system ledger...
        </div>
      )}
              ...
              >
                <div className="flex justify-between items-center">
                  <span className="text-xs font-mono font-bold text-emerald-400 flex items-center gap-1">
                    <FaHashtag className="text-[10px] text-white/30" /> {txn.transactionId}
                  </span>
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[11px] text-white/40 flex items-center gap-2 font-mono">
                    <FaCalendarAlt className="text-[10px] text-white/30 shrink-0" /> {new Date(txn.date).toLocaleDateString()}
                  </p>
                </div>
                ...
                <div className="pt-2 border-t border-white/[0.03] flex justify-between items-center">
                  ...
                  <span className="text-sm font-mono font-black text-white flex items-center">
                    <FaDollarSign className="text-[11px] text-emerald-400" /> {Number(txn.amount).toFixed(2)}
                  </span>
                </div>
              </motion.div>
            ))}
